                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo $row['role'] === 'faculty' ? 'info' : 'success'; ?>">
    ...
    <script>
        document.querySelectorAll(".edit-btn").forEach(button => {
            button.addEventListener("click", function() {
                ...
                let newRole = prompt(`Edit role for ${username} (faculty/student):`, role);
                if (newRole && (newRole === "faculty" || newRole === "student")) {
